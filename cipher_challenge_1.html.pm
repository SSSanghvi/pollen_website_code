...
◊article{
	◊section{
		◊h1{Solving Stage 1 of the Cipher Challenge}
        ◊h5{◊em{December 26, 2021}}
		◊p{
			◊span[#:class "small-caps"]{be warned}◊br{}
        ...
        ◊h3{Introduction}
        ◊p{
            This holday season, I had the free time to start reading a new book. I began reading ◊em{The Code Book} by Simon Singh, and almost immediately was drawn in by the puzzle-like nature of the ciphers being presented.
        }
        ◊p{
        ...
        ◊p{
			◊span[#:class "small-caps"]{the ciphertext:}◊br{}
            ◊code[#:display "block"]{
        ...
        ◊p{
            ◊span[#:class "small-caps"]{notation}◊br{}
        ...
        ◊p{
            As I read in the beginning of the book, and as I learned studying Data Science, it's always good to start with some exploratory data analysis. While it wasn't specified anywhere, I (correctly) assumed that the language of the original message was English. For a sample of English plaintext, I used this ◊a[#:href "https://lite.cnn.com/en/article/h_7dde3051bca2542215494f9fd77c8030"]{CNN article}. 
        }

        ◊p{
            After doing some simple preprocessing in Python◊label[#:for "code_link" #:class "margin-toggle sidenote-number"]{}
				◊input[#:type "checkbox" #:id "code_link" #:class "margin-toggle"]{}
				◊span[#:class "sidenote"]{
					If you'd like to see the code behind this writeup, you can find it ◊a[#:href "https://github.com/SSSanghvi/cipher_challenge/blob/main/stage1.ipynb"]{on my Github Profile}.
				}, I first plotted the frequencies of individual letters in both texts:
        }

        ◊figure{
            ◊img[#:src "img/cc_s1/plaintext_single_frequencies.png"]{}
        }
        ◊figure{
            ◊img[#:src "img/cc_s1/ciphertext_single_frequencies.png"]{}
		}
        ...
        ◊figure{
            ◊img[#:src "img/cc_s1/plaintext_single_word_counts.png"]{}
        }
        ◊figure{
            ◊img[#:src "img/cc_s1/ciphertext_single_word_counts.png"]{}
		}
        ...
        ◊figure{
            ◊img[#:src "img/cc_s1/plaintext_2letter_counts.png"]{}
        }
        ◊figure{
            ◊img[#:src "img/cc_s1/ciphertext_2letter_counts.png"]{}
		}
        ...
        ◊figure{
            ◊img[#:src "img/cc_s1/plaintext_3letter_counts.png"]{}
        }
        ◊figure{
            ◊img[#:src "img/cc_s1/ciphertext_3letter_counts.png"]{}
		}

        ◊p{
            We see our clearest signal yet - \(JPX_C\) and \(THE_P\) seem to be highly related. This matches with our previous observation about \(X_C\) = \(E_P\), but not the guess that \(CI_C\) = \(TO_P\). I have more confidence in the former, so let's start with the following set of substitutions:
            $${J_C=T_P, P_C=H_P, X_C=E_P}$$
        }
        ...
        ◊p{
            I won't bore you with each and every guess to a substitution - if you would like to see them all, please take a look at the code on GitHub◊label[#:for "code_link_2" #:class "margin-toggle sidenote-number"]{}
				◊input[#:type "checkbox" #:id "code_link_2" #:class "margin-toggle"]{}
				◊span[#:class "sidenote"]{
					If you'd like to see the code behind this writeup, you can find it ◊a[#:href "https://github.com/SSSanghvi/cipher_challenge/blob/main/stage1.ipynb"]{on my Github Profile}.
				}. 
        }
        ...
        ◊p{
            The last sentence stands out from the rest of the text: ◊em{the first codeword is othello}. Hmm... perhaps a clue to a later stage of the challenge?
        }
